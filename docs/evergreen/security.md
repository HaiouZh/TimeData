...
<!-- 复核 2026-06-22（目标层 Phase 1）：sync route 新增 tasks.goal_id force-push 显式列；认证、限流、确认 token 机制不变。 -->
