...
interface EntryFormProps {
  ...
  onSave: (categoryId: string, startTime: string, endTime: string, note: string) => void;
  onDelete?: () => void;
  onCancel: () => void;
}
...
export default function EntryForm({ startTime, endTime, existingEntry, onSave, onDelete, onCancel }: EntryFormProps) {
  ...
  function handleSave() {
    ...
    setError("");
    onSave(categoryId, nextStartTime, nextEndTime, note);
  }
