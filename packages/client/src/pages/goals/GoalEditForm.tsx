...
export function GoalEditForm({ goal, active, onSave, onToggleArchive, onDelete }: GoalEditFormProps) {
  ...
  }, [active, goal.kind, goal.note, goal.title]);
